...
public interface IReservaRepository extends JpaRepository<Reserva, Integer> {
    ...
    @Query(value = "select rr.* from notium.reserva_restaurante rr join notium.cliente on rr.id_cliente = cliente.id join notium.usuario u on cliente.id_usuario = u.id where u.id = :id_usuario order by rr.fecha desc", nativeQuery = true)
